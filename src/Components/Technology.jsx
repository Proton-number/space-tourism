...
function Technology() {
  ...
  return (
    <Box
      sx={{
        backgroundImage: {
          xs: 'url("/src/assets/technology/background-technology-mobile.jpg")',
          sm: 'url("/src/assets/technology/background-technology-tablet.jpg")',
          lg: 'url("/src/assets/technology/background-technology-desktop.jpg")',
        },
