...
function Crew() {
  ...
  return (
    <Box
      sx={{
        backgroundImage: {
          xs: 'url("/public/assets/crew/background-crew-mobile.jpg")',
          sm: 'url("/public/assets/crew/background-crew-tablet.jpg")',
          lg: 'url("/public/assets/crew/background-crew-desktop.jpg")',
        },
