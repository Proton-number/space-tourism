  ...
  return (
    <>
      <Box
        sx={{
          backgroundImage: {
            xs: 'url("/src/assets/destination/background-destination-mobile.jpg")',
            sm: 'url("/src/assets/destination/background-destination-tablet.jpg")',
            lg: 'url("/src/assets/destination/background-destination-desktop.jpg")',
          },
